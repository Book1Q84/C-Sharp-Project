...
namespace CompanyManageSystem
{
    public partial class goods_analyse_Form : Form
    {
        ...
        * 
        */
        private DataTable getinproduct()
        {
            String sql = "select * from in_product";
            MySqlDataAdapter sda = new MySqlDataAdapter(sql, conn);
            DataTable ds = new DataTable();
            sda.Fill(ds);
            //MessageBox.Show(ds.Rows[0][0].ToString()+ ds.Rows[0][1].ToString()+ ds.Rows[0][2].ToString());
        ...
        private DataTable getioutproduct()
        {
        ...
        */
         ...
         * 根据同类名称产品销售的数量绘制饼状图
         */
        private void createImage(ref saleProduct[] sale,int t)
        {
            //创建画图对象
            int temp = t;
            ...
            try
            {
                ...
                if (temp == 1)
                {
                    g.DrawString("商品进货比例饼状图", font[0], brush[1], new Point(80, 20));
                }//书写标题
                if (temp == 2) 
                {
                    g.DrawString("商品进货退货比例饼状图", font[0], brush[1], new Point(80, 20));
                }
        ...
        private void goods_analyse_Form_Load(object sender, EventArgs e)
        {
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            saleproduct = this.getinproduct();          //调用getSaleproduct方法
            //创建对象数组
